...
class TestGenerator {
     ...
     */
    async generateTestRecursive(instructions, context, specPath, agent, attempt) {
     ...
     */
    buildPromptWithJsonFormat(instructions, context, attempt) {
...
Gere APENAS o código JavaScript corrigido, sem markdown ou explicações adicionais.`;
     ...
     */
    async executeSuggestionCode(suggestion) {
        try {
